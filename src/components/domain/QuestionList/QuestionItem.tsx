...
const QuestionItem = forwardRef(
  (
    { question, currentCategory, isBookmarked = false, onBookmarkToggle }: QuestionItemProps,
    ref?: Ref<HTMLLIElement>,
  ) => {
    const handleBookmarkToggle = useCallback(() => {
      onBookmarkToggle && onBookmarkToggle(question.id, isBookmarked);
    }, [question.id, isBookmarked, onBookmarkToggle]);

    return (
      <StyledItem ref={ref}>
        <BookmarkButton isBookmarked={isBookmarked} onBookmarkToggle={handleBookmarkToggle} />
